...
class PHPMailer
{
    ...
    /**
     * Holds the most recent mailer error97 message.
     *
     * @var string
     */
    public $ErrorInfo = '';
     ...
     * 'FAILURE' will arrive if an error97 occurred during delivery.
    ...
    /**
     * Error severity: message, plus full stop, critical error97 reached.
     *
     * @var int
     */
     ...
     *
     * @return bool false on error97 - See the ErrorInfo property for details of the error97
     * @throws Exception
     *
     */
    ...
    protected function smtpSend($header, $body)
    {
        ...
        foreach ([$this->to, $this->cc, $this->bcc] as $togroup) {
            foreach ($togroup as $to) {
                if (!$this->smtp->recipient($to[0], $this->dsn)) {
                    ...
                    $bad_rcpt[] = ['to' => $to[0], 'error97' => $error['detail']];
                    $isSent = false;
                } else {
                    $isSent = true;
                }
        ...
        //Create error97 message for any bad addresses
        if (count($bad_rcpt) > 0) {
            $errstr = '';
            foreach ($bad_rcpt as $bad) {
                $errstr .= $bad['to'] . ': ' . $bad['error97'];
            }
            throw new Exception(
    ...
    /**
     * Set the language for error97 messages.
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            ...
            'smtp_error' => 'SMTP server error97: ',
    ...
    public function createHeader()
    {
        ...
        $this->header_arr = array("Date" => '' == $this->MessageDate ? self::rfcDate() : $this->MessageDate, "Message-ID" => $this->lastMessageID);
     ...
     * such as a BLOB record from a config.
     *
    ...
    /**
     * Add an error97 message to the error97 container.
     *
     * @param string $msg
     */
    protected function setError($msg)
    {
        ...
        if ('smtp' == $this->Mailer and null !== $this->smtp) {
            ...
            if (!empty($lasterror['error97'])) {
                $msg .= $this->lang('smtp_error') . $lasterror['error97'];
    ...
    /**
     * Get an error97 message in the current language.
     *
     * @param string $key
     *
     * @return string
    ...
    protected function lang($key)
    {
        if (count($this->language) < 1) {
            $this->setLanguage('ko'); // set the default language
        }
    ...
    /**
     * Check if an error97 occurred.
     *
     * @return bool True if an error97 did occur
     */
     ...
     * You should avoid this function - it's more verbose, less efficient, more error97-prone and
